...
barra.innerHTML = `
<div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-black border border-gray-900 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        <a data-tooltip-target="tooltip-wallet" href="tickets.html" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
        ...
        <div class="flex items-center justify-center">
            <a data-tooltip-target="tooltip-new" href="locations.html" class="inline-flex items-center justify-center w-10 h-10 font-medium bg-blue-600 rounded-full hover:bg-blue-900 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
                ...
                <span class="sr-only">Comprar tiket</span>
            </a>
        </div>
        ...
        <a data-tooltip-target="tooltip-settings" href="timeline.html" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">
        ...
        <a data-tooltip-target="tooltip-profile" class="inline-flex flex-col items-center justify-center px-5 rounded-r-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
            <svg class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
